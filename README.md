...
Total: **27,961** lines of code across **136** files in the top 5 languages.
...
- **Stars**: 2,717 · **Forks**: 111 · **Open issues**: 170 · **Contributors**: 42

## Totals (cumulative)

- **Releases**: 32 · **Merged PRs**: 53 · **Open PRs**: 1 · **Closed issues**: 103 · **Open issues**: 67 · **Commits**: 547
...
Reported by **21** distros on [repology.org](https://repology.org/project/mprocs). **6** are ✅ on the latest upstream release, **14** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T05:16:41Z._
